...
lit_rate <- lit_rate %>% mutate(score = ((3*(score-0.75207))/(1-0.75207))) # scaling range of geom_line
...
labs <- c("Female Unemployment (standardized)", "Male Unemployment (standardized)", "Female Vulnerable Employment (standardized)", "Male Vulnerable Employment (standardized)")
...
laborforce %>%
  ...
  scale_colour_manual(values = c("#F44D5C", "#1E8FCB","#01937C","#E798AE", "#04009A","#064420","#FFBBCC","#77ACF1" )) +
  theme_minimal() +
  theme( 
...
# Codes For Refugee Population Graph
